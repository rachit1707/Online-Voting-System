...
<nav class="navbar navbar-inverse">
	...
	<form id="msform" action="CheckResult">
		<!-- Fieldsets -->
		<fieldset>
			<h2 class="fs-title">Enter Pin Code</h2>
			
			<input type="text" name="pin" placeholder="Aadhar Number"> <input
				type="submit" name="next" value="Check Results" class="next action-button" style="width:150px;">
		</fieldset>
</form>
</body>
<footer>
