...
<body>
	...
	<form id="msform" action="CheckResult" name="f1">
		
		<!-- Fieldsets -->
		<fieldset>
			<h2 class="fs-title">Enter Area to Check Votes</h2>
			
			<input type="text" name="pin" placeholder="Pincode" > <input
				type="submit" name="next" value="Check Results" class="next action-button" style="width: 150px;" onclick="err()">
		</fieldset>
	</form>
</body>
<footer>
