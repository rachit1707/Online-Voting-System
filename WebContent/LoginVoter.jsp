...
<script type="text/javascript">
	function err() {
		if (document.f1.username.value == ""
				|| document.f1.password.value == ""|| document.f1.code.value=="")
			alert("Empty Field");
	}
	</script>
<link
...
body{
	background-image: url("Images/VoterPnnel.jpg");
...
<body>
	...
	<form id="msform" action="LoginServlet" name="f1">
		<!-- Fieldsets -->
		<fieldset>
			...
			<input type="submit" name="login" value="Login" class="next action-button" onclick="err()">
