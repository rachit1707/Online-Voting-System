...
<link
	...
	rel="stylesheet">
<meta http-equiv="Refresh" content="5;url=VoterPannel.jsp">
<style>
		body{
...
<body onload="time()">
	...
	<h1 style="margin-left: 500px;
				margin-top: 100px;">Result Not Published Yet</h1><br>
			<h3 style="margin-left: 570px;"></h3>
			<h3 style="margin-left: 425px;">This Page Will Be Redirected To voter pannel In <span id="displaySeconds">5</span> Seconds</h3>
