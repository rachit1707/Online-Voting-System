...
<body onload="time()">
	...
	<h1 style="margin-left: 500px;
				margin-top: 100px;">You Have already Voted.</h1><br>
			<h3 style="margin-left: 570px;">Thank you for Your Vote</h3>
			<h3 style="margin-left: 425px;">This Page Will Be Redirected To Home In <span id="displaySeconds">5</span> Seconds</h3>
