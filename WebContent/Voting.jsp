...
<title>OVS | Voting</title>
</head>
<style>
@import url(http://fonts.googleapis.com/css?family=Roboto:400,500,700,300,100);

body { background: #3e94ec;font-family: "Roboto", helvetica, arial, sans-serif;font-size: 16px;font-weight: 400;text-rendering: optimizeLegibility;}
...
<body>
			...
			<thead>
					<form action="Voting">
							...
							<tbody class="table-hover">
									<tr>
											<td><%out.println(arr.get(i).getCandiAdno()); %></td>
											<td><%out.println(arr.get(i).getCandiName()); %></td>
											<td><%out.println(arr.get(i).getCandiAge()); %></td>
											<td><%out.println(arr.get(i).getCandiParty()); %></td>
											<td><%out.println(arr.get(i).getCandiVoterArea()); %></td>
											<td><%out.println(arr.get(i).getCandiVotingPin()); %></td>
											<td><input type="radio" name="choice" value="<%out.println(arr.get(i).getCandiAdno());%>"></td>
									</tr>
							</tbody>
							<%} %>
							<tr>
			...
			<td></td>
			<td></td>
			<td><button type="submit" class="btn btn-default">Vote</button></td>
		</tr>
