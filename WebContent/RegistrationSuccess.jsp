...
<title>OVS | Registration Success</title>
</head>
...
<body>
	...
	<form id="msform" action="">
		...
		<fieldset>
			...
			<h3 class="fs-subtitle">Password has been sent to your registered Email Id with Secret Code.If in any case you did not receive it please contact the administrator.</h3>
		</fieldset>
		</form>
</body>
<footer>
